...
Driver.belongsToMany(Team, { through: "driver_team" }); // un driver puede pertenecer a muchos equipos
Team.belongsToMany(Driver, { through: "driver_team" }); // un equipo puede tener muchos drivers
